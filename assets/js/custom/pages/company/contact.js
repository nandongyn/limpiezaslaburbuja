...
var KTContactApply = function () {
  ...
  var initMap = function (elementId) {
    ...
    L.marker([41.4043256062588, 2.161433996570654], { icon: leafletIcon }).addTo(markerLayer).bindPopup('Joan Blanques 5-7 local 3, 08012, Barcelona', { closeButton: false }).openPopup();
      ...
      form,
      {
        fields: {
          ...
          'message': {
            validators: {
              notEmpty: {
                message: 'Mensaje es obligatório'
              }
            }
          }
        },
        ...
        validator.validate().then(function (status) {
          ...
          if (status == 'Valid') {
            ...
            setTimeout(function () {
              ...
              Swal.fire({
                text: "¡Gracias por ponerte en contacto con nosotros!, Hemos recibido tu mensaje y te daremos respuesta lo antes posible.",
                icon: "success",
                buttonsStyling: false,
                confirmButtonText: "Volver a laburbuja",
                customClass: {
                  confirmButton: "btn btn-primary"
                }
              }).then(function (result) {
