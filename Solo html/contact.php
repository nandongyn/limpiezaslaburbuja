...
<html lang="en">
	...
	<head><base href="../../">
			<meta charset="utf-8" />
			<title>laburbuja Limpieza Multiservicios</title>
			<meta name="description"
				content="Limpieza Multiservicios. Oficinas,Comunidades,Final de obra,Parkings,Bares y restaurantes,Discotecas,Locales de ocio,Centros médicos,Centros de prevención,de riesgos laborables,Clínicas privadas,Tiendas y locales,Grandes superficies,Limpieza de cristales,Limpieza de tapizados,Domicilios,Pulido de pavimentos,Desinfección con ozono" />
			<meta name="keywords"
				content="Limpieza,Serviciosde limpieza,Barcelona,Limpieza en Barcelona,Limpieza Multiservicios. Oficinas,Comunidades,Final de obra,Parkings,Bares y restaurantes,Discotecas,Locales de ocio,Centros médicos,Centros de prevención,de riesgos laborables,Clínicas privadas,Tiendas y locales,Grandes superficies,Limpieza de cristales,Limpieza de tapizados,Domicilios,Pulido de pavimentos,Desinfección con ozono" />
			<link rel="canonical" href="https://limpiezaslaburbuja.com/" />
									...
									<div class="menu-sub menu-sub-accordion menu-active-bg">
										...
										<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
											...
											<div class="menu-sub menu-sub-accordion menu-active-bg">
												...
												<div class="menu-item">
													<a class="menu-link active" href="pages/company/contact.html">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
														...
														<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
															...
															<div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item here show menu-lg-down-accordion">
																...
																<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
																	...
																	<div class="menu-item">
																		<a class="menu-link active py-3" href="pages/company/contact.html">
																			<span class="menu-bullet">
																				<span class="bullet bullet-dot"></span>
																			</span>
																			<span class="menu-title">Contact Us</span>
						...
						<div class="toolbar" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Contact Us</h1>
									<!--end::Title-->
									<!--begin::Separator-->
										...
										<div class="row g-5 mb-5 mb-lg-15">
											...
											<div class="col-sm-6 ps-lg-10">
												...
												<div class="text-center bg-light card-rounded d-flex flex-column justify-content-center p-10 h-lg-100">
													...
													<!--end::Subtitle-->
													<!--begin::Description-->
													<div class="text-gray-700 fs-3 fw-bold">Carrer de Joan Blanques, 5, local 3.</div>
													<!--end::Description-->
												</div>
												<!--end::Address-->
											</div>
